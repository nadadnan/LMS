...
<%
    ...
    try {
        ...
        e.printStackTrace();
        out.println("<p style='color:red'>Error loading order summary: " + e.getMessage() + "</p>");
    }
%>
...
<head>
    ...
    <style>
        ...
        .order-container { max-width: 800px; margin: auto; background-color: #fff; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-radius: 10px; }
        .order-header { border-bottom: 2px solid #007bff; padding-bottom: 10px; margin-bottom: 20px; }
        .summary { background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin-bottom: 20px; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th, td { border: 1px solid #ddd; padding: 10px; text-align: left; }
        th { background-color: #007bff; color: white; }
        .back-btn { display: inline-block; margin-top: 20px; text-decoration: none; padding: 10px 15px; background-color: #007bff; color: white; border-radius: 5px; transition: background-color 0.3s ease; }
        ...
        <table>
            ...
            <tbody>
                ...
                <%
                        ...
                        e.printStackTrace();
                        out.println("<tr><td colspan='4' style='color:red;'>Error loading items: " + e.getMessage() + "</td></tr>");
                    }
                %>
            </tbody>
        </table>
